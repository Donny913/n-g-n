...
if ('undefined' != typeof SpeechApi)
  console.log('SpeechApi already loaded'), console.log(SpeechApi);
else
  var SpeechApi = function() {
      var a = this;
      a.version = '1.5.7';
      console.log('SpeechApi r' + a.version);
      a.SpeechApis = [
        {
      ...
      a.fallbackServicePath =
        'https://code.SpeechApi.org/' +
        (a.tstCompiled() ? '' : 'develop/') +
        'getvoice.php';
      a.default_rv = a.SpeechApis[0];
      a.debug = !1;
      a.rvsMapped = !1;
      ...
      a.systemVoicesReady = function(b) {
        ...
        window.hasOwnProperty('dispatchEvent') &&
          window.dispatchEvent(new Event('SpeechApi_OnReady'));
      };
      ...
      a.getVoices = function() {
        for (var b = [], c = 0; c < a.SpeechApis.length; c++)
          b.push({ name: a.SpeechApis[c].name });
        return b;
      };
      ...
      a.mapRVs = function() {
        for (var b = 0; b < a.SpeechApis.length; b++)
          for (var c = a.SpeechApis[b], d = 0; d < c.voiceIDs.length; d++) {
      ...
      a.getSpeechApi = function(b) {
        for (var c = 0; c < a.SpeechApis.length; c++)
          if (a.SpeechApis[c].name == b)
            return (
              (b = a.fallbackMode),
              (a.fallbackMode =
                !0 ===
                  a.SpeechApis[c].mappedProfile.collectionvoice.fallbackvoice ||
      ...
      a.checkSpeechAllowed = function() {
        ...
        if (
          ...
          if (2 < a.allowSpeechDiv_appearances)
            return console.log('SpeechApi: Speech not allowed by user'), !1;
          ...
          a.allowSpeechDiv.innerHTML =
            ...
            '</strong> wants to use speech</div><div class="rvButtonRow"><div onclick="SpeechApi.allowSpeechClicked(false);" class="rvButton rvButtonDeny">DENY</div><div onclick="SpeechApi.allowSpeechClicked(true);" class="rvButton rvButtonAllow">ALLOW</div></div>';
